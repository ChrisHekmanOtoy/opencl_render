	...
	if (0 == id--) {
		...
		if (id < platformDeviceCount) {
			if (strlen(&platformDeviceName[256 * id]) <= strLen) {
				memcpy(str, &platformDeviceName[256 * id], min(256, strLen));
				return CL_TRUE;
			}
		}
	}
...
RaytraceAll(cl_uint computationType,
	...
	if (0 < computationType--) {
		...
		memobjs[0] = clCreateBuffer(context, CL_MEM_READ_ONLY | CL_MEM_USE_HOST_PTR, sizeof(nextPixelId), &nextPixelId, &err);
		...
		memobjs[1] = clCreateBuffer(context, CL_MEM_READ_ONLY | CL_MEM_USE_HOST_PTR, sizeof(cameraImageDimension), &cameraImageDimension, &err);
		...
		memobjs[2] = clCreateBuffer(context, CL_MEM_READ_ONLY | CL_MEM_USE_HOST_PTR, sizeof(cameraEye), &cameraEye, &err);
		...
		memobjs[3] = clCreateBuffer(context, CL_MEM_READ_ONLY | CL_MEM_USE_HOST_PTR, sizeof(cameraEyeToTopLeftVector), &cameraEyeToTopLeftVector, &err);
		...
		memobjs[4] = clCreateBuffer(context, CL_MEM_READ_ONLY | CL_MEM_USE_HOST_PTR, sizeof(cameraLeftToRightPixelSizeVector), &cameraLeftToRightPixelSizeVector, &err);
		...
		memobjs[5] = clCreateBuffer(context, CL_MEM_READ_ONLY | CL_MEM_USE_HOST_PTR, sizeof(cameraTopToBottomPixelSizeVector), &cameraTopToBottomPixelSizeVector, &err);
		...
		memobjs[6] = clCreateBuffer(context, CL_MEM_READ_ONLY | CL_MEM_USE_HOST_PTR, sizeof(cameraPixelSizeInv), &cameraPixelSizeInv, &err);
		...
		memobjs[7] = clCreateBuffer(context, CL_MEM_READ_ONLY | CL_MEM_USE_HOST_PTR, (cameraImageDimension.s[0] * cameraImageDimension.s[1]) * sizeof(cl_uint), cameraPixelTriangleListStart, &err);
		...
		memobjs[8] = clCreateBuffer(context, CL_MEM_READ_ONLY | CL_MEM_USE_HOST_PTR, (cameraImageDimension.s[0] * cameraImageDimension.s[1]) * sizeof(cl_uint), cameraPixelTriangleListEnd, &err);
		...
		memobjs[9] = clCreateBuffer(context, CL_MEM_READ_ONLY | CL_MEM_USE_HOST_PTR, (size_t)cameraPixelTriangleListSize * sizeof(cl_uint), cameraPixelTriangleList, &err);
		...
		memobjs[10] = clCreateBuffer(context, CL_MEM_READ_WRITE | CL_MEM_USE_HOST_PTR, sizeof(sampleId), &sampleId, &err);
		...
		memobjs[11] = clCreateBuffer(context, CL_MEM_READ_ONLY | CL_MEM_USE_HOST_PTR, sizeof(sampleCount), &sampleCount, &err);
		...
		memobjs[12] = clCreateBuffer(context, CL_MEM_READ_ONLY | CL_MEM_USE_HOST_PTR, vertexCount * sizeof(cl_float3), vertex, &err);
		...
		memobjs[13] = clCreateBuffer(context, CL_MEM_READ_ONLY | CL_MEM_USE_HOST_PTR, sizeof(triangleCount), &triangleCount, &err);
		...
		memobjs[14] = clCreateBuffer(context, CL_MEM_READ_ONLY | CL_MEM_USE_HOST_PTR, triangleCount * sizeof(cl_int3), triangleVertexIndex, &err);
		...
		memobjs[15] = clCreateBuffer(context, CL_MEM_READ_ONLY | CL_MEM_USE_HOST_PTR, triangleCount * sizeof(cl_int), triangleMaterialId, &err);
		...
		memobjs[16] = clCreateBuffer(context, CL_MEM_READ_ONLY | CL_MEM_USE_HOST_PTR, 3 * triangleCount * sizeof(cl_float2), triangleUv, &err);
		...
		memobjs[17] = clCreateBuffer(context, CL_MEM_READ_ONLY | CL_MEM_USE_HOST_PTR, 3 * triangleCount * sizeof(cl_float3), triangleNormal, &err);
		...
		memobjs[18] = clCreateBuffer(context, CL_MEM_READ_ONLY | CL_MEM_USE_HOST_PTR, sizeof(axesDivCount), &axesDivCount, &err);
		...
		memobjs[19] = clCreateBuffer(context, CL_MEM_READ_ONLY | CL_MEM_USE_HOST_PTR, (axesDivCount + 1) * sizeof(cl_float3), sceneBoxMin, &err);
		...
		memobjs[20] = clCreateBuffer(context, CL_MEM_READ_ONLY | CL_MEM_USE_HOST_PTR, (axesDivCount * axesDivCount * axesDivCount + 1) * sizeof(cl_uint), scenePixelTriangleListStart, &err);
		...
		memobjs[21] = clCreateBuffer(context, CL_MEM_READ_ONLY | CL_MEM_USE_HOST_PTR, scenePixelTriangleListStart[axesDivCount * axesDivCount * axesDivCount] * sizeof(cl_uint), scenePixelTriangleList, &err);
		...
		memobjs[22] = clCreateBuffer(context, CL_MEM_READ_ONLY | CL_MEM_USE_HOST_PTR, materialCount * _MATERIAL_CHANNEL_COUNT * sizeof(cl_uint2), materialImageSize, &err);
		...
		memobjs[23] = clCreateBuffer(context, CL_MEM_READ_ONLY | CL_MEM_USE_HOST_PTR, materialCount * _MATERIAL_CHANNEL_COUNT * sizeof(cl_int), materialImageStart, &err);
		...
		memobjs[24] = clCreateBuffer(context, CL_MEM_READ_ONLY | CL_MEM_USE_HOST_PTR, materialImageStart[materialCount * _MATERIAL_CHANNEL_COUNT] * sizeof(cl_uchar3), textures, &err);
		...
		memobjs[25] = clCreateBuffer(context, CL_MEM_READ_ONLY | CL_MEM_USE_HOST_PTR, sizeof(lightCount), &lightCount, &err);
		...
		memobjs[26] = clCreateBuffer(context, CL_MEM_READ_ONLY | CL_MEM_USE_HOST_PTR, lightCount * sizeof(cl_int), lightType, &err);
		...
		memobjs[27] = clCreateBuffer(context, CL_MEM_READ_ONLY | CL_MEM_USE_HOST_PTR, lightCount * sizeof(cl_float3), lightPosition, &err);
		...
		memobjs[28] = clCreateBuffer(context, CL_MEM_READ_ONLY | CL_MEM_USE_HOST_PTR, lightCount * sizeof(cl_float3), lightDirection, &err);
		...
		memobjs[29] = clCreateBuffer(context, CL_MEM_READ_ONLY | CL_MEM_USE_HOST_PTR, lightCount * sizeof(cl_float3), lightColour, &err);
		...
		memobjs[30] = clCreateBuffer(context, CL_MEM_READ_ONLY | CL_MEM_USE_HOST_PTR, lightCount * sizeof(cl_float), lightRadius, &err);
		...
		memobjs[31] = clCreateBuffer(context, CL_MEM_READ_ONLY | CL_MEM_USE_HOST_PTR, lightCount * sizeof(cl_float), lightHalfAttenuationDistance, &err);
		...
		memobjs[32] = clCreateBuffer(context, CL_MEM_READ_WRITE | CL_MEM_USE_HOST_PTR, cameraImageDimension.s[0] * cameraImageDimension.s[1] * sizeof(cl_ushort), outputRed, &err);
		...
		memobjs[33] = clCreateBuffer(context, CL_MEM_READ_WRITE | CL_MEM_USE_HOST_PTR, cameraImageDimension.s[0] * cameraImageDimension.s[1] * sizeof(cl_ushort), outputGreen, &err);
		...
		memobjs[34] = clCreateBuffer(context, CL_MEM_READ_WRITE | CL_MEM_USE_HOST_PTR, cameraImageDimension.s[0] * cameraImageDimension.s[1] * sizeof(cl_ushort), outputBlue, &err);
